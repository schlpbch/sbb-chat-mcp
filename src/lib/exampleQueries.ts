...
export const exampleQueries: ExampleQuery[] = [
  ...
  },
  {
    id: 'arrivals-1',
    text: {
      en: 'Arrivals at Genève-Aéroport',
      de: 'Ankünfte am Flughafen Genf',
      fr: 'Arrivées à l\'aéroport de Genève',
      it: 'Arrivi all\'aeroporto di Ginevra',
      zh: '日内瓦机场的到达',
      hi: 'जिनेवा हवाई अड्डे पर आने वाली',
    },
    category: 'stations',
    icon: '✈️',
    description: {
