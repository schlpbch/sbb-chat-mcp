...
import ExampleQueryCard, { LocalizedExampleQuery } from './ExampleQueryCard';
import { useState } from 'react';

const meta: Meta<typeof ExampleQueryCard> = {
  title: 'Cards/ExampleQueryCard',
  component: ExampleQueryCard,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
...
export default meta;
type Story = StoryObj<typeof ExampleQueryCard>;
...
function ExampleQueryDemo({ example }: { example: LocalizedExampleQuery }) {
  ...
  return (
    <div className="space-y-4">
      <ExampleQueryCard example={example} onClick={handleClick} />
      {clicked && (
...
export const Playground: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Interactive playground to test example query card interactions.',
      },
    },
  },
};
