...
interface ExampleQuerySnippetProps {
...
export default function ExampleQuerySnippet({
  example,
  onClick,
}: ExampleQuerySnippetProps) {
  const handleClick = () => {
  ...
  const IconComponent =
    iconMap[normalizedIcon] || iconMap[example.icon] || MessageCircle;
