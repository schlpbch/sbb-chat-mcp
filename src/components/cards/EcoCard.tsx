...
function EcoCard({ data, language }: EcoCardProps) {
 ...
 <span className="text-xs font-medium text-gray-700 dark:text-gray-300">{t.eco.train}</span>
 ...
 <div className="flex-1">
 <div className="flex items-center justify-between mb-0.5">
 <span className="text-xs font-medium text-gray-700 dark:text-gray-300">{t.eco.car}</span>
 ...
 <div className="flex-1">
 <div className="flex items-center justify-between mb-0.5">
 <span className="text-xs font-medium text-gray-700 dark:text-gray-300">{t.eco.plane}</span>
 ...
 <div>
 <p className="text-xs text-gray-600 dark:text-gray-400">{t.eco.equivalentTo}</p>
