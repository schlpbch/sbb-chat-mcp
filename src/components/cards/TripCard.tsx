        ...
        {isExpanded && (
          <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700 space-y-2">
            {legs.map((leg: any, idx: number) => {
              ...
              return (
                <div key={idx} className="flex items-start space-x-2 p-2 bg-gray-50 dark:bg-gray-900 rounded-lg text-sm">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center space-x-2 mb-1">
                      ...
                      {direction && (
                        <span className="text-xs text-gray-600 dark:text-gray-400 truncate">→ {direction}</span>
                      )}
                    </div>
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400 truncate">{legStart.name}</span>
                        {legStart.platform && (
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400 truncate">{legEnd.name}</span>
                        {legEnd.platform && (
                          <span className="text-xs px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded shrink-0">
                            Pl. {legEnd.platform}
                          </span>
