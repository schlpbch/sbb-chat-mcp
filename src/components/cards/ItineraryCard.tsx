      ...
      <div className="p-3">
          ...
          <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-100">
            {transportation && (
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t.itinerary.transport}</p>
            ...
            {budget && budget.total !== undefined && (
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">{t.itinerary.budget}</p>
        ...
        {activities.length > 0 ? (
              ...
              <div key={idx} className="flex items-start space-x-3">
                <div className="flex flex-col items-center shrink-0">
                  ...
                  {idx < activities.length - 1 && (
                    <div className="w-0.5 h-full min-h-6 bg-gray-100 mt-2"></div>
                  )}
                </div>
                ...
                <div className="flex-1 min-w-0 pb-3">
                  <div className="flex items-start justify-between mb-1">
                    ...
                    {activity.time && (
                      <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded shrink-0 ml-2">
                        {activity.time}
                      </span>
                    )}
                  </div>
                  ...
                  {activity.location && (
                    <div className="flex items-center space-x-1.5 text-[10px] font-bold text-gray-400 uppercase tracking-tight">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm font-medium text-gray-400">{t.itinerary.noActivities}</p>
          </div>
        )}
      </div>
    </article>
