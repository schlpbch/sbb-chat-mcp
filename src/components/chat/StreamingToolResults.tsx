      ...
      {streamingToolCalls.map((toolCall, idx) => {
        ...
        if (status === 'complete') {
          ...
          if (toolName === 'getEcoComparison') {
            ...
            const ecoResultObj = result as Record<string, unknown> | undefined;
            if (ecoResultObj?.error) {
              logger.error(
                'StreamingToolResults',
                'getEcoComparison error',
                result
              );
              return (
                <div
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-red-800 dark:text-red-300">
                        {(ecoResultObj.error as string) ||
                          'Failed to load eco comparison'}
                      </p>
                      <p className="text-xs text-red-700 dark:text-red-400 mt-1">
                        Unable to retrieve environmental impact data. This may
                        be due to a backend service issue.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-yellow-700 dark:text-yellow-400 mt-1">
                      The eco comparison tool returned no data. Please try
                      again.
                    </p>
                  </div>
                </div>
