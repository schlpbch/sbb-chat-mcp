    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400 mb-4">Resource not found</p>
          <button
    ...
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Error */}
          {error && (
            <div className="mb-4 bg-red-50 dark:bg-red-950 border-l-4 border-red-500 text-red-700 dark:text-red-300 px-4 py-3 rounded">
