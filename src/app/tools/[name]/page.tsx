        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  ([key, schema]: [string, any]) => (
                    <div key={key}>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none"
                      />
                      {schema.description && (
                        <p
                          id={`desc-${key}`}
            ...
            <div className="bg-white dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 p-4">
              ...
              {error && (
                <div className="bg-red-50 dark:bg-red-950 border-l-4 border-red-500 text-red-700 dark:text-red-300 px-3 py-2 text-sm rounded mb-3">
                  {error}
                </div>
              )}
          ...
          {/* Schema Info */}
          <details className="mt-4 bg-white dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 p-4">
            <summary className="text-sm font-semibold text-gray-700 dark:text-gray-300 cursor-pointer hover:text-blue-600">
              View Full Schema
            </summary>
            <div className="mt-3 bg-gray-50 dark:bg-gray-900 p-3 rounded border border-gray-200 dark:border-gray-700">
