      ...
      <div className="flex flex-col min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
        ...
        <main className="flex-1 flex items-center justify-center p-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">This share link is missing required information.</p>
            <a
              href="/"
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  {dep && <p className="text-sm text-gray-600 mt-1">Departure: {dep}</p>}
                </div>
                <div className="px-4">
                  <svg className="w-8 h-8 text-sbb-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex-1 text-right">
                  ...
                  {arr && <p className="text-sm text-gray-600 mt-1">Arrival: {arr}</p>}
                </div>
              </div>
