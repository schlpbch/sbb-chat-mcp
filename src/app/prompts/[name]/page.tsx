    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400 mb-4">Prompt not found</p>
          <button
      ...
      <div className="flex-1 overflow-auto p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {/* Input Form */}
            <section 
              className="bg-white dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 p-4"
            ...
            >
              ...
              {error && (
                <div
                  role="alert"
                  aria-live="assertive"
                  className="bg-red-50 dark:bg-red-950 border-l-4 border-red-500 text-red-700 dark:text-red-300 px-3 py-2 text-sm rounded mb-3"
                >
                  {error}
                </div>
              )}
