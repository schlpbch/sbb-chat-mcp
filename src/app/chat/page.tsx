...
export default function ChatPage() {
 ...
 return (
 <div className="flex flex-col h-screen bg-milk">
 <Navbar
 language={language}
 ...
 <div className="flex flex-col flex-1 bg-white rounded-sbb-xl shadow-sbb-xl border border-cloud/30 overflow-hidden">
 <header className="px-8 py-6 border-b border-cloud/30">
 <h1 className="text-2xl font-black text-midnight tracking-tighter">
 AI Travel Assistant
 </h1>
 <p className="text-[10px] font-black uppercase tracking-widest text-smoke mt-1">
 ...
 <h2 className="text-3xl font-black mb-2 text-midnight tracking-tighter">
 Hello!
 </h2>
 <p className="text-base mb-12 font-medium text-anthracite">
 ...
 className="p-5 bg-milk border border-cloud rounded-sbb-lg text-sm font-bold text-anthracite hover:border-sbb-red hover:text-sbb-red transition-all duration-200 text-left flex justify-between items-center group shadow-sbb-sm"
 >
 ...
 >
 <div className="bg-milk text-midnight border border-cloud/50 rounded-sbb-lg px-5 py-4 shadow-sbb">
 ...
 : 'bg-milk text-midnight border border-cloud/50'
 }`}>
 ...
 <footer className="p-6 bg-white border-t border-cloud/30">
 <form 
 ...
 disabled={isLoading}
 className="flex-1 px-6 py-4 bg-milk rounded-sbb-lg border border-cloud text-midnight focus:outline-none focus:border-sbb-red transition-all font-bold text-sm shadow-inner"
 />
