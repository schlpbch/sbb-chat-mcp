                    ...
                    <details className="group">
                      <summary className="cursor-pointer text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-sbb-red dark:hover:text-red-400 flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-900/50 transition-colors">
                        <div className="flex items-center space-x-2">
                          ...
                          <span>
                            Available Tools (
                            {healthData.checks.mcp.toolsList.length})
                          </span>
                        </div>
                        <svg
                      ...
                      <div className="mt-3 space-y-2 max-h-96 overflow-y-auto">
                        {healthData.checks.mcp.toolsList.map(
                          (tool: any, idx: number) => (
                            <div
                              key={idx}
                    ...
                    <details className="group">
                      <summary className="cursor-pointer text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-sbb-red dark:hover:text-red-400 flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-900/50 transition-colors">
                        <div className="flex items-center space-x-2">
                          ...
                          <span>
                            Available Prompts (
                            {healthData.checks.mcp.promptsList.length})
                          </span>
                        </div>
                        <svg
                          className="w-5 h-5 transition-transform group-open:rotate-180"
                      ...
                      <div className="mt-3 space-y-2 max-h-96 overflow-y-auto">
                        {healthData.checks.mcp.promptsList.map(
                    ...
                    <details className="group">
                      <summary className="cursor-pointer text-sm font-semibold text-gray-700 dark:text-gray-300 hover:text-sbb-red dark:hover:text-red-400 flex items-center justify-between p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-900/50 transition-colors">
                        <div className="flex items-center space-x-2">
                          ...
                          <span>
                            Available Resources (
                            {healthData.checks.mcp.resourcesList.length})
                          </span>
                        </div>
                        <svg
                          className="w-5 h-5 transition-transform group-open:rotate-180"
                      ...
                      <div className="mt-3 space-y-2 max-h-96 overflow-y-auto">
                        {healthData.checks.mcp.resourcesList.map(
